      ...
      <div className="mx-auto grid max-w-7xl gap-8 px-4 py-12 sm:px-6 md:grid-cols-2 lg:grid-cols-5">
        <div className="lg:col-span-2">
          ...
          <div className="mt-4 space-y-2 text-sm">
            <p className="flex items-center gap-2 text-muted-foreground"><MapPin className="h-4 w-4 text-karto-green" /> Karto HQ, Bandra West, Mumbai 400050</p>
            <p className="flex items-center gap-2 text-muted-foreground"><Mail className="h-4 w-4 text-karto-green" /> support@karto.shop</p>
            <p className="flex items-center gap-2 text-muted-foreground"><Phone className="h-4 w-4 text-karto-green" /> 1800-200-KARTO</p>
          </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li><button onClick={() => scrollTo("why-us")} className="transition hover:text-karto-green">About Us</button></li>
            <li><button onClick={() => scrollTo("reviews")} className="transition hover:text-karto-green">Reviews</button></li>
